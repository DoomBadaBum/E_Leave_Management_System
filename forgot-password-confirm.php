...
if(isset($_POST['change'])){
    if($_POST["newpassword"] == $_POST["confirmpassword"]) {
        ...
        $chngpwd1->execute();
            print '<script>alert("Password has been succssfully changed!");</script>';
            print '<script>window.location.assign("index.php");</script>'; 
        } 
    else{
        print '<script>alert("New password and confirm password are not the same");</script>';
        print '<script>window.location.assign("forgot-password-confirm.php");</script>'; 
    }
}
?>
...
<body style="background-color:#d2d6de;">
    ...
    <div class="mn-content fixed-sidebar">
        ...
        <div class="row">
                    <div class="col s12">
                        <h4 class="font-weight-bold text-center black-text">E-Leave Management System</h4>

                          <div class="col s12 m6 l8 offset-l2 offset-m3">
                              <div class="card white darken-1">

                                  <div class="card-content ">
                                      <span class="card-title black-text" style="font-size:20px;">Change your password</span>
