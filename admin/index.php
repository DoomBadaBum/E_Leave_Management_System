...
<nav class="navbar navbar-expand-lg navbar-light py-3">
          ...
          <div class="navbar-nav d-flex justify-content-center align-items-center">
            ...
            <a class="nav-item text-white nav-link ml-3" href="#">Admin Login</a>
    ...
    <div class="col-md-3"></div>
                          <div class="col-md-6 d-flex justify-content-center align-items-center">
                              <div class="card white darken-1">
                                  ...
                                  <img style="align: center;" class="map2u-center" src="../assets/images/map2u.png" alt="map2u">
                                  <br><br><br>
                                      <span class="card-title" style="text-transform:none; font-weight: normal; text-align:center;font-size:15px; color:black;">Admin Login</span>
                                       <div class="row">
                                           <form class="col s12" name="signin" method="post">
                                               ...
                                               <div class="col s12 center m-t-sm">
                                                   ...
                                                   <input type="submit" name="signin" value="Login" style="margin-top:30px; padding-left:135px; padding-right:135px;" class="waves-effect waves-light btn teal">
                                               </div>
                                           </form>
                                      </div>
                                  </div>
