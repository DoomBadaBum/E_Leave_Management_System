    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title" style="color: black;">Approved Leave History</div>
                    </div>
                                ...
                                <table id="example" class="display responsive-table ">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="color: black;" width="200">Employe Name</th>
                                            <th style="color: black;" width="120">Leave Type</th>

                                             <th style="color: black;" width="180">Posting Date</th>                 
                                            <th style="color: black;">Status</th>
                                            <th style="color: black; position:relative; right:-110px;">Action</th>
                                        </tr>
                                    </thead>
