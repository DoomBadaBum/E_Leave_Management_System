                        ...
                        <div class="col s12 m12 l12 col-md-12">
                            <div class="card invoices-card border-0 shadow">
                                <div class="card-content">
                                    ...
                                    <span class="card-title black-text">Latest Leave Applications</span>
                             <table id="example" class="display responsive-table bg-transparent">
                                    <thead>
                                        <tr>
                                            <th class="black-text">No.</th>
                                            <th width="200" class="black-text">Employe Name</th>
                                            <th width="120" class="black-text">Leave Type</th>

                                             <th width="180" class="black-text">Posting Date</th>                 
                                            <th class="black-text">Status</th>
                                            <th style="Position:relative; right:-88px;" class="black-text text-center" >Action</th>
                                        </tr>
                                    </thead>
