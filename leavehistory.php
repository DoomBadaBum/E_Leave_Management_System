    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title" style="color:black;">Leave History</div>
                    </div>
                                ...
                                <table id="example" class="display responsive-table ">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="color: black;" width="120">Type Of Leave</th>
                                            <th style="color: black;">From</th>
                                            <th style="color: black;">To</th>
                                             <th style="color: black;">Description</th>
                                             <th style="color: black;" width="120">Posting Date</th>
                                            <th style="color: black;" width="200">Admin Remark</th>
